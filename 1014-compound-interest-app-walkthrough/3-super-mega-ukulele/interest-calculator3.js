...
//Voor nu ff alles wegcommenten wat nog niet nodig is



//put everything needed to export in a function so it can get exported?
let interestCalculator3 = () => {
   

var folder = (__dirname + "/customers")
fs.readdir(folder, function (err, files) {
    ...
    files.map(function (file) {
		...
		fs.readFile( file, "utf-8", ( err, data ) => {//new kind of function writing
...
let calcCompound = ( customer ) => {
	...
	//Welcome customer
	console.log ("\nWelcome " + customer.name + " to our pension planner!")
...
module.exports = interestCalculator3